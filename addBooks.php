...
if($bn!=NULL && $au!=NULL && $available!=NULL)
{
	$sql=mysqli_query($set,"INSERT INTO books(name,author,available) VALUES('$bn','$au','$available')");
	if($sql)
	{
...
<tr><td class="labels">Available Book : </td><td><input type="text" name="available" placeholder="Enter Book number" size="25" class="fields" required="required"  /></td></tr>
