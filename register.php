...
$sid=$_POST['sid'];
$pas=sha1($_POST['pass']);
if($name==NULL || $roll==NULL || $phone==NULL || $email==NULL || $sem==NULL || $branch==NULL || $sid==NULL || $_POST['pass']==NULL)
{
	//
}
else
{
	$sql=mysqli_query($set,"INSERT INTO students(sid,name,roll,phone,branch,sem,password,email) VALUES('$sid','$name','$roll','$phone','$branch','$sem','$pas','$email')");
	if($sql)
	{
	...
	<br>
		<div align="center">
			<div id="wrapper">			
				<br>				
					<div>
						<span class="SubHead">Student Registration Form</span>
						<br />
						<br />
						...
						<tr><td class="labels">Roll No : </td><td><input type="roll" name="roll" class="fields" placeholder="Enter Roll No" required="required" size="25" /></td></tr>
						<tr><td class="labels">Reg. No : </td><td><input type="text" name="reg" class="fields" placeholder="Enter Reg. No" required="required" size="25" /></td></tr>
						...
						<td>
						<select name="gender" class="fields" required>
