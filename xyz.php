...
if($bn!=NULL && $au!=NULL)
{
	$sql=mysqli_query($set,"INSERT INTO books(name,author,day) VALUES('$bn','$au','$day')");
	if($sql)
	{
	...
	<div align="center">
		<div id="wrapper">
			...
			<table border="0" class="table" cellpadding="10" cellspacing="10">
				<tr class="labels" style="text-decoration:underline;"><th>Book Name</th><th>Author</th><th>Issued By<br>ID</th><th>Date</th><th>For Day</th><th>Return</th></tr>
				<?php
